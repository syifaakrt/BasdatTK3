...
def claim_list(request):
    ...
    return render(request, 'main/claim_list.html', {
        'claims': claims,
...
def staf_claim_list(request):
    ...
    return render(request, 'main/staf_claim_list.html', {
        'claims': claims,
        'maskapai_list': maskapai_list,
        'status_filter': status_filter,
...
def transfer_list(request):
    ...
    return render(request, 'main/transfer_list.html', {
        'transfers': transfers,
...
def pengaturan_profile(request):
    ...
    return render(request, 'main/pengaturan_profile.html', {
        'profil': profil,
        'role': role,
        'maskapai_list': maskapai_list,
    })
